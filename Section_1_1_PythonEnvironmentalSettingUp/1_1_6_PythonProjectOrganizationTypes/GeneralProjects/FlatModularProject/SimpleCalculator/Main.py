...
import Utils as ut;
from Utils import divideTwoNumbers;
...
def processingStep_2():
    ...
    result = ut.addTwoNumbers(number1, number2);
    ...
    number1 = 10; number2 = 20;
    result = ut.subtractTwoNumbers(number1, number2);
...
def processingStep_3():
    ...
    multiplier = ut.TwoNumberMultiplier(number1, number2);
